...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://iyonm.com/video-to-gif" },
};
...
const jsonLd = {
  ...
  "@graph": [
    ...
    { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://iyonm.com" }, { "@type": "ListItem", position: 2, name: "Video to GIF", item: "https://iyonm.com/video-to-gif" }] },
  ],
};
