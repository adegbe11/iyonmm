...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.iyonm.com/pdf-to-markdown" },
};
...
const jsonLd = {
  ...
  "@graph": [
    ...
    { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://www.iyonm.com" }, { "@type": "ListItem", position: 2, name: "PDF to Markdown", item: "https://www.iyonm.com/pdf-to-markdown" }] },
  ],
};
