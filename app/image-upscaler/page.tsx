...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.iyonm.com/image-upscaler" },
};
...
const jsonLd = {
  ...
  "@graph": [
    ...
    { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://www.iyonm.com" }, { "@type": "ListItem", position: 2, name: "AI Image Upscaler", item: "https://www.iyonm.com/image-upscaler" }] },
  ],
};
