...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://iyonm.com/sign-pdf" },
};
...
const jsonLd = {
  ...
  "@graph": [
    ...
    { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://iyonm.com" }, { "@type": "ListItem", position: 2, name: "Sign PDF", item: "https://iyonm.com/sign-pdf" }] },
  ],
};
